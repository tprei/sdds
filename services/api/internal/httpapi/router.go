...
func newRouter(
	...
	router.Route("/v1", func(router chi.Router) {
		...
		router.With(authRateLimiters.signupSource).Post("/auth/users", wrapper.CreateAuthUser)
		router.With(authRateLimiters.loginSource).Post("/auth/sessions", wrapper.CreateAuthSession)
