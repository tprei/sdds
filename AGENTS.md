...
- Follow the [design-system guide](agent-guidance/DESIGN_SYSTEM.md), the [frontend coding guide](agent-guidance/writing/WRITING_FRONTEND_CODE.md), and the writing guides in `agent-guidance/writing/WRITING_GO.md`, `agent-guidance/writing/WRITING_REACT_NATIVE.md`, `agent-guidance/writing/WRITING_TYPESCRIPT.md`, and `agent-guidance/writing/STACKED_DIFFS.md`.
...
- Frontend development MUST start by reading and using `artifacts/design-system/DESIGN_SYSTEM.html`, the frontend coding guide, design-system tokens, and small local primitives.
