...
const defaults = { size: 24, color: semanticColors.textBody, strokeWidth: 2 };
...
export function IconSearch({
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Circle cx="11" cy="11" r="7" stroke={color} strokeWidth={filled ? 2.6 : strokeWidth} />
      <Path
        d="m20 20-3.5-3.5"
        stroke={color}
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        ...
        strokeLinejoin="round"
      />
      <Path d="M4 22v-7" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    </Svg>
  );
}
