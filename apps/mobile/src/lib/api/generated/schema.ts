...
export interface paths {
    ...
    "/v1/auth/oidc/sessions": {
        ...
        post: operations["createAuthOidcSession"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/auth/identities/{identity_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        DeleteUserRequest: {
            /** @description The account's current password, re-entered to confirm deletion. */
            password: string;
        };
        CreateUserRequest: {
            username: string;
...
export interface operations {
    ...
    deleteAuthUser: {
        ...
        responses: {
            /** @description The account and all of its content were deleted. */
            204: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The request is not authenticated, or the password did not match. */
            401: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Too many account-deletion attempts are in flight. */
            429: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The API could not delete the account. */
            500: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    createAuthOidcSession: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateOidcSessionRequest"];
            };
        };
        responses: {
            /** @description The identity token was exchanged for a session. */
            201: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The request JSON or the chosen username is invalid. */
            400: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The identity token is not valid. */
            401: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The subject is new and needs a username, or the username is taken. */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Too many provider sign-in requests are in flight or recently attempted. */
            429: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Provider sign-in is not configured. */
            503: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    deleteAuthIdentity: {
        ...
        responses: {
            ...
            /** @description The identity does not exist or belongs to another user. */
            404: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The identity is the caller's only remaining way in. */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The API could not delete the identity. */
            500: {
                headers: {
                    [name: string]: unknown;
                };
